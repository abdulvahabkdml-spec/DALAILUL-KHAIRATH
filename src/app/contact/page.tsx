                        ...
                        <div className={styles.infoContent}>
                            ...
                            <div className="flex flex-wrap gap-3">
                                ...
                                <a
                                    ...
                                    aria-label="Facebook"
                                    className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl border border-[#1877F2]/20 bg-[#1877F2]/5 hover:bg-[#1877F2]/15 hover:border-[#1877F2]/40 hover:-translate-y-1 hover:shadow-md transition-all duration-300 group"
                                >
                                ...
                                <a
                                    ...
                                    className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl border border-[#E1306C]/20 bg-[#E1306C]/5 hover:bg-[#E1306C]/15 hover:border-[#E1306C]/40 hover:-translate-y-1 hover:shadow-md transition-all duration-300 group"
                                >
                                ...
                                {/* YouTube */}
                                <a
                                    href="https://www.youtube.com/channel/UCXjMWmjXq4hB7jBNU8zkkpw"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    aria-label="YouTube"
                                    className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl border border-[#FF0000]/20 bg-[#FF0000]/5 hover:bg-[#FF0000]/15 hover:border-[#FF0000]/40 hover:-translate-y-1 hover:shadow-md transition-all duration-300 group"
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="w-5 h-5 fill-[#FF0000] flex-shrink-0">
                                        <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.5 12 3.5 12 3.5s-7.505 0-9.377.55a3.016 3.016 0 0 0-2.122 2.136C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.55 9.377.55 9.377.55s7.505 0 9.377-.55a3.016 3.016 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                                    </svg>
                                    <span className="text-sm font-semibold text-[#FF0000] group-hover:text-[#FF0000]">YouTube</span>
                                </a>
                            </div>
                        </div>
                    </div>
