                    ...
                    <div className={styles.infoCard}>
                        ...
                        <div className={styles.infoContent}>
                            ...
                            <div className="flex flex-wrap gap-3">
                                {/* Facebook */}
                                <div className="rounded-xl p-[1.5px] animate-border-gradient hover:-translate-y-1 hover:shadow-md transition-all duration-300">
                                    <a
                                        href="https://www.facebook.com/profile.php?id=100095405598376&mibextid=ZbWKwL"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        aria-label="Facebook"
                                        className="flex items-center gap-2.5 px-4 py-2.5 rounded-[10.5px] bg-white hover:bg-slate-50 transition-all group h-full w-full"
                                    >
