                ...
                <div className="flex flex-col md:flex-row justify-between items-start gap-8">
                    ...
                    <div className="w-full md:w-[26%] flex flex-col">
                        ...
                        <div className="flex gap-[10px]">
                            <a href="https://www.facebook.com/profile.php?id=100095405598376&mibextid=ZbWKwL" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg border border-white/20 flex items-center justify-center hover:bg-white/10 hover:border-white/50 hover:-translate-y-1 hover:shadow-md transition-all duration-300" aria-label="Facebook">
                            ...
                            <a href="https://www.instagram.com/dalailul_khairath_?igsh=eXZiYXBrMGtlN2U2" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg border border-white/20 flex items-center justify-center hover:bg-white/10 hover:border-white/50 hover:-translate-y-1 hover:shadow-md transition-all duration-300" aria-label="Instagram">
                            ...
                            <a href="https://www.youtube.com/channel/UCXjMWmjXq4hB7jBNU8zkkpw" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg border border-white/20 flex items-center justify-center hover:bg-white/10 hover:border-white/50 hover:-translate-y-1 hover:shadow-md transition-all duration-300" aria-label="YouTube">
                            ...
                            <a href="#" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg border border-white/20 flex items-center justify-center hover:bg-white/10 hover:border-white/50 hover:-translate-y-1 hover:shadow-md transition-all duration-300" aria-label="LinkedIn">
